...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DocVAKDetAcoMsgEnv.aspx.vb" Inherits="VAKItfUsrWeb.DocVAKDetAcoMsgEnv" %>
			...
			<asp:panel id="PnlDdoFlu" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 136px" runat="server"
				...
				<TABLE id="Table21" style="VERTICAL-ALIGN: top; HEIGHT: 136px" cellSpacing="0" cellPadding="0"
					...
					<TR>
						...
						<TD bgColor="#e0eafc">
							<asp:Label id="Label3" runat="server" Font-Bold="True">Comunicação Enviada</asp:Label></TD>
								...
								<TR>
									<TD style="HEIGHT: 11.19%" vAlign="top" align="left">
										<TABLE id="Table24" style="HEIGHT: 24px" cellSpacing="1" cellPadding="1" width="100%" bgColor="#e0eafc"
											...
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 19px" align="right">
													<asp:Label id="Label2" runat="server" Width="133px">Fluxo:</asp:Label></TD>
												<TD style="HEIGHT: 19px">
													<asp:Label id="lblFluxo" runat="server">0000</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 17px" align="right">
													<asp:Label id="Label4" runat="server" Width="133px">Representante:</asp:Label></TD>
												<TD style="HEIGHT: 17px">
													<asp:Label id="lblRepresentante" runat="server">0000 - XXXXXXXXXXXX</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 19px" align="right">
													<asp:Label id="Label5" runat="server" Width="133px">Núm. Seq.:</asp:Label></TD>
												<TD style="HEIGHT: 19px">
													<asp:Label id="lblNumSeq" runat="server">0000</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 19px" align="right">
													<asp:Label id="Label8" runat="server" Width="133px">Data Envio:</asp:Label></TD>
												<TD style="HEIGHT: 19px">
													<asp:Label id="lblDatCri" runat="server">0000</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 20px" align="right">
													<asp:Label id="Label7" runat="server" Width="133px">Remetente:</asp:Label></TD>
												<TD style="HEIGHT: 20px">
													<asp:Label id="lblRem" runat="server">xxxx@xxxx.com</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 20px" align="right">
													<asp:Label id="Label6" runat="server" Width="133px">Para:</asp:Label></TD>
												<TD style="HEIGHT: 20px">
													<asp:Label id="lblDsn" runat="server">xxxx@xxxx.com</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 20px" align="right">
													<asp:Label id="Label9" runat="server" Width="133px">Com cópia:</asp:Label></TD>
												<TD style="HEIGHT: 20px">
													<asp:Label id="lblComCop" runat="server">xxxx@xxxx.com</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 20px" align="right">
													<asp:Label id="Label1" runat="server" Width="133px">C.c. oculta:</asp:Label></TD>
												<TD style="HEIGHT: 20px">
													<asp:Label id="lblComCopOcu" runat="server">xxxx@xxxx.com</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px; HEIGHT: 20px" align="right">
													<asp:Label id="Label10" runat="server" Width="133px">Assunto:</asp:Label></TD>
												<TD style="HEIGHT: 20px">
													<asp:Label id="lblAssunto" runat="server">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</asp:Label></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 120px" align="right">
													<asp:Label id="lblObs" runat="server" Width="133px">Mensagem:</asp:Label></TD>
												<TD>
													<asp:TextBox id="txtMsg" runat="server" Width="100%" MaxLength="240" TextMode="MultiLine" Rows="10"
